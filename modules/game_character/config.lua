-- chunkname: @/modules/game_character/config.lua
...
baseGlobalCooldown = 1500
baseCriticalDamage = 1.3
baseCriticalChance = 5
minAttackSpeed = 1000
minChannelingTimePercent = 50
minGlobalCooldown = 1000
maxCriticalDamage = 2
maxCriticalChance = 100
maxStatsTooltip = "Your stats have reached the maximum allowed."
...
TITLE_NONE = -1
TITLE_DEV_MODE = 0
TITLE_BETA_EXPLORER = 1
TITLE_BETA_CONQUEROR = 2
TITLE_LAGBANE = 3
TITLE_VERY_IMPORTANT_VAMPIRE = 4
TITLE_HONORARY_VAMPIRE = 5
TITLE_COMMUNITY_MANAGER = 6
TITLE_GAMEMASTER = 7
TITLE_EARLY_BIRD = 8
TITLE_I_WAS_THERE = 9
titles = {
