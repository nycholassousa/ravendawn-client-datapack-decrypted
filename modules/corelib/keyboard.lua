...
local function onWidgetKeyPress(widget, keyCode, keyboardModifiers, autoRepeatTicks)
	...
	return signalcall(callback, widget, keyCode, autoRepeatTicks, determineKeyComboDesc(keyCode, keyboardModifiers))
end
...
function g_keyboard.bindKeyDown(keyComboDesc, callback, widget, alone)
	...
	if alone then
		return connect(widget.boundAloneKeyDownCombos, keyComboDesc, callback)
	else
		return connect(widget.boundKeyDownCombos, keyComboDesc, callback)
	end
end
...
function g_keyboard.bindKeyUp(keyComboDesc, callback, widget, alone)
	...
	if alone then
		return connect(widget.boundAloneKeyUpCombos, keyComboDesc, callback)
	else
		return connect(widget.boundKeyUpCombos, keyComboDesc, callback)
	end
end
...
function g_keyboard.bindKeyPress(keyComboDesc, callback, widget)
	...
	return connect(widget.boundKeyPressCombos, keyComboDesc, callback)
end
