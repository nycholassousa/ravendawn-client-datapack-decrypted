...
function GameMarket:updateCompletedOffersListPagination()
	...
	self.completedOffersWindow.paginationPanel.page_count:setText(string.format("of %i", max_pages), true)
end
...
function GameMarket:displayCompletedOffers(offers, resultsAmount)
	...
	for i, offer in ipairs(offers) do
		...
		transactionWidget.icon:setImageSource(string.format("/images/ui/windows/market/offer_type_%s", offer.offerType == OFFER_TYPE_SELL and "sell" or "buy"))
		statusWidget.text:setText(cfg.offerStateText[offer.state])
