-- chunkname: @/modules/gamelib/ui/uichattabbar.lua

UIChatTabBar = extends(UIWidget, "UIChatTabBar")
...
function UIChatTabBar.create()
	local tabbar = UIChatTabBar.internalCreate()
...
function UIChatTabBar:onDestroy()
...
function UIChatTabBar:setContentWidget(widget)
...
function UIChatTabBar:setTabSpacing(tabSpacing)
	self.tabSpacing = tabSpacing

	updateMargins(self)
end

function UIChatTabBar:addTab(text, panel, menuCallback)
	if panel == nil then
...
function UIChatTabBar:moveTab(tab, units)
...
function UIChatTabBar:onStyleApply(styleName, styleNode)
...
function UIChatTabBar:removeTab(tab)
	local tabTables = {
		self.tabs,
		self.preTabs,
		self.postTabs
...
function UIChatTabBar:getTab(text)
...
function UIChatTabBar:selectTab(tab)
	if self.currentTab == tab then
		return
	end
...
function UIChatTabBar:selectNextTab()
...
function UIChatTabBar:selectPrevTab()
	if self.currentTab == nil then
		return
	end
...
function UIChatTabBar:blinkTab(tab)
	...
	tabBlink(tab, 0, 2, 800)
end

function UIChatTabBar:getTabPanel(tab)
	return tab.tabPanel
end

function UIChatTabBar:getCurrentTabPanel()
	if self.currentTab then
		return self.currentTab.tabPanel
	end
end

function UIChatTabBar:getCurrentTab()
	return self.currentTab
end

function UIChatTabBar:setNavigation(prevButton, nextButton)
