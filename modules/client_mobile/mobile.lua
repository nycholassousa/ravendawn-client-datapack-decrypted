-- chunkname: @/modules/client_mobile/mobile.lua
...
function toggleKeyPadLock()
	local keypad = modules.client_mobile.overlay.keypad

	if keypad:isDraggable() then
		keypad:setDraggable(false)
		keypad:setBorderWidth(2)
		keypad:setBorderColor("red")
	else
		keypad:setDraggable(true)
		keypad:setBorderWidth(0)
	end
end
