				...
				UIWidget = {
					onVisibilityChange = function(widget, visible)
						if not visible then
							...
							local parentWidget = modules.game_inventory.GameInventory:findItemWidgetByItemType("normalPanel", "potion")
					...
					onVisibilityChange_normalPanel = function(widget, visible)
						addEvent(function()
			...
			displayInteraction = function(self)
				...
				if inventoryWindow:isVisible() then
					...
					if parentWidget then
						...
						table.insert(self.disconnects, connect(modules.game_inventory.GameInventory.normalPanel, {
							onVisibilityChange = self.callbacks.UIWidget.onVisibilityChange_normalPanel
						}))
					end
