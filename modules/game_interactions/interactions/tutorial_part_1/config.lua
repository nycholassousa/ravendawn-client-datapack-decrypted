		...
		},
		{
			...
			onStartInteraction = function(self)
				GameInteractions:displayDescriptionBox({
					...
					parent = modules.game_inventory.GameInventory.selectionPanel.normal,
		...
		},
		{
			...
			onStartInteraction = function(self)
				...
				if inventoryWindow:isVisible() then
					local parentWidget = modules.game_inventory.GameInventory:findItemWidgetByItemType("normalPanel", "weapon")
			...
			onStartInteraction = function(self)
				...
				if inventoryWindow:isVisible() then
					GameInteractions:displayDescriptionBox({
						...
						parent = modules.game_inventory.GameInventory.selectionPanel.quest,
						callbackOnClose = function()
							GameInteractions:advanceInteraction(__env, eatCake, 2)
						end
					})
		...
		},
		{
			...
			callbacks = {
				...
				UIWidget = {
					...
					onVisibilityChange_questPanel = function(widget, visible)
						addEvent(function()
							modules.game_inventory.GameInventory:selectInventoryType("quest")
						end)
					end
				},
				g_game = {
